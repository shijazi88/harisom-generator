    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.services.update", [$service->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('service_type') ? 'is-invalid' : '' }}" type="text" name="service_type" id="service_type" value="{{ old('service_type', $service->service_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spend_time') ? 'is-invalid' : '' }}" type="text" name="spend_time" id="spend_time" value="{{ old('spend_time', $service->spend_time) }}" required>
