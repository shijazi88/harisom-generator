...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.workerAddress.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.worker-addresses.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('home_lat') ? 'is-invalid' : '' }}" type="number" name="home_lat" id="home_lat" value="{{ old('home_lat', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('home_lng') ? 'is-invalid' : '' }}" type="number" name="home_lng" id="home_lng" value="{{ old('home_lng', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('location_info') ? 'is-invalid' : '' }}" name="location_info" id="location_info" required>{{ old('location_info') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address_extra_details') ? 'is-invalid' : '' }}" name="address_extra_details" id="address_extra_details" required>{{ old('address_extra_details') }}</textarea>
